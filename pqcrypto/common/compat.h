...
/* xCoin: upstream spells this __clang__major__, an undefined macro that
 * evaluates to 0 (so the polyfill was always emitted under clang, and -Wundef
 * warns). The intended predefined macro is __clang_major__. */
