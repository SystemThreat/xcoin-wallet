...
/* xCoin local change (see ../ml-dsa-65/PQCLEAN): the Keccak state lives inline
 * in the context instead of behind a malloc'd pointer, so the *_init and
 * *_ctx_clone functions cannot fail (upstream calls exit(111) when malloc
